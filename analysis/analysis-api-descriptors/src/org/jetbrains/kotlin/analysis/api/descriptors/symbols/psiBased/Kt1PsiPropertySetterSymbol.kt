...
internal class Kt1PsiPropertySetterSymbol(
    override val psi: KtPropertyAccessor,
    override val analysisSession: Kt1AnalysisSession
) : KtPropertySetterSymbol(), Kt1PsiSymbol<KtPropertyAccessor, PropertySetterDescriptor> {
    ...
    override val parameter: KtValueParameterSymbol
        get() = withValidityAssertion {
            ...
            return if (parameter != null) {
                Kt1PsiValueParameterSymbol(parameter, analysisSession)
            } else {
                Kt1PsiDefaultSetterParameterSymbol(psi, analysisSession)
            }
        }
