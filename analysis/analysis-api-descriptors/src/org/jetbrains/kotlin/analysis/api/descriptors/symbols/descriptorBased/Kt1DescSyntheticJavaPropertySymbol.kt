...
internal class Kt1DescSyntheticJavaPropertySymbol(
    override val descriptor: SyntheticJavaPropertyDescriptor,
    override val analysisSession: Kt1AnalysisSession
) : KtSyntheticJavaPropertySymbol(), Kt1DescMemberSymbol<SyntheticJavaPropertyDescriptor> {
    ...
    override val javaGetterSymbol: KtFunctionSymbol
        get() = withValidityAssertion { Kt1DescFunctionSymbol(descriptor.getMethod, analysisSession) }
