...
internal class Kt1DescSyntheticJavaPropertySymbolForOverride(
    override val descriptor: JavaForKotlinOverridePropertyDescriptor,
    override val analysisSession: Kt1AnalysisSession
) : KtSyntheticJavaPropertySymbol(), Kt1DescMemberSymbol<JavaForKotlinOverridePropertyDescriptor> {
    ...
    override val getter: KtPropertyGetterSymbol
        get() = withValidityAssertion {
            ...
            return Kt1DescPropertyGetterSymbol(getter, analysisSession)
        }
    override val javaGetterSymbol: KtFunctionSymbol
        get() = withValidityAssertion { Kt1DescFunctionSymbol(descriptor.getterMethod, analysisSession) }

    override val javaSetterSymbol: KtFunctionSymbol?
        get() = withValidityAssertion {
            val setMethod = descriptor.setterMethod ?: return null
            return Kt1DescFunctionSymbol(setMethod, analysisSession)
        }
    ...
    override val setter: KtPropertySetterSymbol?
        get() = withValidityAssertion {
            ...
            Kt1DescPropertySetterSymbol(setter, analysisSession)
        }
    ...
    private class EmptyGetterSymbol(
        ...
        override val analysisSession: Kt1AnalysisSession
    ) : KtPropertyGetterSymbol(), Kt1Symbol {
