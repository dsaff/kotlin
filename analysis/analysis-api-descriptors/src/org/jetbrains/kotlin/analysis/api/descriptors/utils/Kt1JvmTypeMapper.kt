...
internal class Kt1JvmTypeMapper(private val resolveSession: ResolveSession) : TypeMappingContext<JvmSignatureWriter> {
    companion object {
    ...
    override val typeContext = Kt1TypeSystemCommonBackendContextForTypeMapping(resolveSession)
