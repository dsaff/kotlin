...
internal class Kt1DescKotlinPropertySymbol(
    override val descriptor: PropertyDescriptorImpl,
    override val analysisSession: Kt1AnalysisSession
) : KtKotlinPropertySymbol(), Kt1DescMemberSymbol<PropertyDescriptorImpl> {
    ...
    override val setter: KtPropertySetterSymbol?
        get() = withValidityAssertion {
            ...
            return Kt1DescPropertySetterSymbol(setter, analysisSession)
        }
