...
import org.jetbrains.kotlin.analysis.api.descriptors.symbols.descriptorBased.Kt1DescAnnotationCall
...
internal interface Kt1AnnotatedSymbol : KtAnnotatedSymbol, Kt1Symbol {
    val annotationsObject: Annotations

    override val annotations: List<KtAnnotationCall>
        get() = withValidityAssertion {
            annotationsObject.map { Kt1DescAnnotationCall(it, token) }
        }
