...
internal class Kt1PsiDefaultSetterParameterSymbol(
    private val accessorPsi: KtPropertyAccessor,
    override val analysisSession: Kt1AnalysisSession
) : KtValueParameterSymbol(), Kt1Symbol {
    private val descriptor: VariableDescriptor? by cached {
        val bindingContext = analysisSession.analyze(accessorPsi, Kt1AnalysisSession.AnalysisMode.PARTIAL)
