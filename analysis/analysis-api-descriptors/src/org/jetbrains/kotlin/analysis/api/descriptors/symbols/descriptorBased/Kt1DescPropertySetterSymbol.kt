...
internal class Kt1DescPropertySetterSymbol(
    override val descriptor: PropertySetterDescriptor,
    override val analysisSession: Kt1AnalysisSession
) : KtPropertySetterSymbol(), Kt1DescMemberSymbol<PropertySetterDescriptor> {
    ...
    override val parameter: KtValueParameterSymbol
        get() = withValidityAssertion { Kt1DescValueParameterSymbol(descriptor.valueParameters.single(), analysisSession) }
