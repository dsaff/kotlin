...
internal class Kt1SymbolContainingDeclarationProvider(
    ...
    override fun getContainingDeclaration(symbol: KtSymbol): KtSymbolWithKind? {
        ...
        return when (symbol) {
            ...
            is Kt1DescSymbol<*> -> symbol.descriptor.containingDeclaration?.toKtSymbol(analysisSession) as? KtSymbolWithKind
            is Kt1PsiSymbol<*, *> -> {
