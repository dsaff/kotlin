...
import org.jetbrains.kotlin.analysis.api.descriptors.symbols.pointers.Kt1DescSamConstructorSymbolPointer
...
internal class Kt1DescSamConstructorSymbol(
    override val descriptor: SamConstructorDescriptor,
    override val analysisSession: Kt1AnalysisSession
) : KtSamConstructorSymbol(), Kt1DescSymbol<SamConstructorDescriptor> {
    ...
    override fun createPointer(): KtSymbolPointer<KtSamConstructorSymbol> = withValidityAssertion {
        ...
        if (classId != null) {
            return Kt1DescSamConstructorSymbolPointer(classId)
        }
