...
class Kt1CliAnalysisSessionProvider(project: Project) : CachingKtAnalysisSessionProvider<Kt1CliAnalysisSessionProvider.State>(project) {
    private val Project.analysisCompletedHandler: Kt1AnalysisHandlerExtension
        get() {
            return AnalysisHandlerExtension.extensionPointName.getExtensions(this).firstIsInstanceOrNull()
                ?: error(Kt1AnalysisHandlerExtension::class.java.name + " should be registered")
        }
    ...
    override fun createAnalysisSession(
        ...
        return Kt1CliAnalysisSession(resolveState.resolveSession, resolveState.deprecationResolver, contextElement, validityToken)
    }
...
private class Kt1CliAnalysisSession(
    override val resolveSession: ResolveSession,
    override val deprecationResolver: DeprecationResolver,
    contextElement: KtElement,
    token: ValidityToken
) : Kt1AnalysisSession(contextElement, token) {
    ...
    override fun createContextDependentCopy(originalKtFile: KtFile, elementToReanalyze: KtElement): KtAnalysisSession {
        return Kt1CliAnalysisSession(resolveSession, deprecationResolver, elementToReanalyze, token)
    }
}

class Kt1AnalysisHandlerExtension : AnalysisHandlerExtension {
