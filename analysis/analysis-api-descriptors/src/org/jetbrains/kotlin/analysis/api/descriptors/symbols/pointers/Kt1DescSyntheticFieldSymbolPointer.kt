...
import org.jetbrains.kotlin.analysis.api.descriptors.symbols.descriptorBased.Kt1DescSyntheticFieldSymbol
...
class Kt1DescSyntheticFieldSymbolPointer(
    ...
    override fun restoreSymbol(analysisSession: KtAnalysisSession): KtBackingFieldSymbol? {
        ...
        return Kt1DescSyntheticFieldSymbol(syntheticFieldDescriptor, analysisSession)
    }
}