...
internal class Kt1PsiKotlinPropertySymbol(
    override val psi: KtProperty,
    override val analysisSession: Kt1AnalysisSession
) : KtKotlinPropertySymbol(), Kt1PsiSymbol<KtProperty, PropertyDescriptor> {
    ...
    override val getter: KtPropertyGetterSymbol?
        get() = withValidityAssertion {
            ...
            return Kt1PsiPropertyGetterSymbol(getter, analysisSession)
        }

    override val setter: KtPropertySetterSymbol?
        get() = withValidityAssertion {
            val setter = psi.setter ?: return null
            return Kt1PsiPropertySetterSymbol(setter, analysisSession)
        }
