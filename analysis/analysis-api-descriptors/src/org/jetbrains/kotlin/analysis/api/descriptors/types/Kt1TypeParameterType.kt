...
import org.jetbrains.kotlin.analysis.api.descriptors.symbols.descriptorBased.Kt1DescTypeParameterSymbol
...
internal class Kt1TypeParameterType(
    ...
    override val symbol: KtTypeParameterSymbol
        get() = withValidityAssertion { Kt1DescTypeParameterSymbol(parameter, analysisSession) }
}