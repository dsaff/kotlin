...
internal class Kt1PsiNamedClassOrObjectSymbol(
    override val psi: KtClassOrObject,
    override val analysisSession: Kt1AnalysisSession
) : KtNamedClassOrObjectSymbol(), Kt1PsiSymbol<KtClassOrObject, ClassDescriptor> {
    ...
    override val companionObject: KtNamedClassOrObjectSymbol?
        get() = withValidityAssertion {
            ...
            Kt1PsiNamedClassOrObjectSymbol(companionObject, analysisSession)
        }
